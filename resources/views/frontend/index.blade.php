            ...
            <div class="single-product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        <span>Kshs {{number_format($after_discount, 2)}}</span>
                        <del style="padding-left: 4%;">Kshs{{number_format($product->price, 2)}}</del>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    @foreach($product_lists as $product)
                        ...
                        <div class="single-product">
                            ...
                            <div class="product-content">
                                <h3><a href="{{route('product-detail',$product->slug)}}">{{$product->title}}</a></h3>
                                <div class="product-price">
                                    <span class="old">Kshs{{number_format($product->price,2)}}</span>
                                    @php
                                    $after_discount=($product->price-($product->price*$product->discount)/100)
                                    @endphp
                                    <span>Kshs{{number_format($after_discount,2)}}</span>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="quickview-content">
                                        ...
                                        @php
                                            $after_discount=($product->price-($product->price*$product->discount)/100);
                                        @endphp
                                        <h3><small><del class="text-muted">Kshs{{number_format($product->price,2)}}</del></small>    Kshs{{number_format($after_discount,2)}}  </h3>
